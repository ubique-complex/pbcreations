...
export const About = () => {
	return (
		<>
			<Helmet>
				<title>Pbcreations | Who We Are</title>
				<meta name="description" content="Know more about Pbcreations that what web services they are providing and how much they are charging from the clients in Chandigarh"></meta>
			</Helmet>
			<div className="head portfolio imgg">
				<div className="container">
					<h1 className="text-center"><strong>Proud To Be A </strong>Professional Web Designer</h1>
					{/* <!--<p style="font-size:14px;">Pbcreations  was established in 2017, with a vision to cater something exclusive to our clients by using new  technologies.</p> --> */}
				</div>
			</div>
			...
			<div className="bedcrumb_service">
				<div className="container-fluid">
					<ol className="breadcrumb" vocab="" typeof="BreadcrumbList">
						...
						<li><Link style={{ color: '#1AA470', textDecoration: 'none' }}><span>&nbsp; / Who We Are</span></Link></li>
					</ol>
				</div>
			</div>
			<br />
				...
				<div className="container">
					<div className="row">
						<div className="col-sm-12">
							...
							<p>In 2017, we formed a team of highly qualified IT experts, and now more than 20 experienced professionals are working with Pbcreations. Our experienced professionals are work in different sectors of IT Services.</p><br />
						</div>
					</div>
				</div>
			</div>
			...
			<div className="container">
				<div className="row">
					<div className="col-sm-6 mobile-text">
						<div className="">
							<h2 className="box-header">About <span>Pbcreations</span></h2>
							<p>This segment tells you about Pbcreations businesses, values and commitment, and its management services. As we know that website can become an online identity for any business. Therefore, our team believes that every business should have a site and promote their business on the Internet. For that, businesses need to appoint a team of experts who are indulged in website design and development, digital marketing services to achieve business goals. Our team experienced professionals chalk out innovative, effective, and user-friendly websites applications for clients and help them to deliver business-oriented results.</p>
							<p>Our experts believe in providing top-notch services that include innovative ideas, quality, creativity, and delivering work on time. Pbcreations committed to enhancing your brand's dignity through the latest marketing strategies to achieve the best ROI.</p>
							<p>If you are looking for specific IT services then you have reached the right place. Pbcreations removes the technical barrier and transforms all your business need into the reality that helps us to grow strong business relationships with all types of customers. We're excited to help you out. So, moving forward we have some qualities in the following ways:</p>
				...
				<div className="top_text wow fadeIn animated animated bg_none" style={{ visibility: 'visible' }}>
					...
					<p>Get the best services and packages deal from Pbcreations at an affordable price. Hire a team that delivers work on time without compromising the product quality.</p><br />
				</div>
			</div>
					...
					<div className="container">
						<div className="row">
							<div className="col-sm-12">
								...
								<p>Hire experienced and full-time resources from Pbcreations. Our developers finish their work on time without compromising with the quality. Keep away your concerns by hiring us!</p>
