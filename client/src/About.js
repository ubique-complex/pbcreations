...
export const About = () => {
	return (
		<>
			<Helmet>
				<title>Growth Licious | Who We Are</title>
				<meta name="description" content="Know more about Growth Licious that what web services they are providing and how much they are charging from the clients in Chandigarh"></meta>
			</Helmet>
			<div className="head portfolio imgg">
				<div className="container">
					<h1 className="text-center"><strong>Proud To Be A </strong>Professional Web Designer</h1>
					{/* <!--<p style="font-size:14px;">Growth Licious  was established in 2017, with a vision to cater something exclusive to our clients by using new  technologies.</p> --> */}
				</div>
			</div>
			...
			<div className="bedcrumb_service">
				<div className="container-fluid">
					<ol className="breadcrumb" vocab="" typeof="BreadcrumbList">
						...
						<li><Link style={{ color: '#669940', textDecoration: 'none' }}><span>&nbsp; / Who We Are</span></Link></li>
					</ol>
				</div>
			</div>
			<br />
				...
				<div className="container">
					<div className="row">
						<div className="col-sm-12">
							...
							<p>In 2017, we formed a team of highly qualified IT experts, and now more than 20 experienced professionals are working with Growth Licious. Our experienced professionals are work in different sectors of IT Services.</p><br />
						</div>
					</div>
				</div>
			</div>
			...
			<div className="container">
				...
				<div className="top_text wow fadeIn animated animated bg_none" style={{ visibility: 'visible' }}>
					...
					<p>Get the best services and packages deal from Growth Licious at an affordable price. Hire a team that delivers work on time without compromising the product quality.</p><br />
				</div>
			</div>
					...
					<div className="container">
						<div className="row">
							<div className="col-sm-12">
								...
								<p>Hire experienced and full-time resources from Growth Licious. Our developers finish their work on time without compromising with the quality. Keep away your concerns by hiring us!</p>
