...
export const PsdHtml = () => {
	return (
		<>
			<Helmet>
				<title>Growth Licious | psd-to-html</title>
			</Helmet>
			<div className="head portfolio">
				<div className="container">
					<h1 className="text-center"><strong>PSD </strong> TO HTML</h1>
					<p style={{ fontSize: '17' }}>Growth Licious’s primary objective is to fulfill the client's business requirement and provide them excellent website development services</p>
				</div>
			</div>
			...
			<div className="bedcrumb_service">
				<div className="container-fluid">
					<ol className="breadcrumb" vocab="" typeof="BreadcrumbList">
						...
						<li><Link style={{ color: '#669940' }}><span>PSD to HTML</span></Link></li>
					</ol>
				</div>
			</div>
			<br />
