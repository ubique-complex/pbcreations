...
export const PrivacyPolicy = () => {
	return (
		<>
			<Helmet>
				<title>Growth Licious | Privacy-Policy</title>
			</Helmet>
			...
			<div className="bedcrumb_service">
				<div className="container-fluid">
					<ol className="breadcrumb" vocab="" typeof="BreadcrumbList">
						...
						<li><Link style={{ color: '#669940' }}><span>/ Privacy Policy</span></Link></li>
					</ol>
				</div>
			</div>
			<br />
				...
				<div className="container">
					<div className="row">
						<div className="col-sm-12">
							<h2>Growth Licious <span>Privacy Policy</span></h2>
						</div>
					</div>
				</div>
			</div>
				...
				<div className="container">
					<div className="row">
						<div className="col-sm-12">
							...
							<p>Our privacy policy tells you about our commitment toward clients privacy and information. Growth Licious never discloses personal information that we received from clients.</p>

							<h2 className="box-header">Mail <span>Received From Us</span></h2>
							<p>Mailing services are created by Growth Licious for better solutions. If you are receiving our emails through e-mail marketing, it means you have subscribed our email services. Otherwise, our existing clients used our email service. We respect your time and attention by controlling the frequency of our mailings.</p>
							...
							<p>Growth Licious use suitable security measures to protect your valuable information against the loss, misuse and alteration of data used by our system.</p>
